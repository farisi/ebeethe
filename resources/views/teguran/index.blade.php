...
<div  class="card">
        <div class="card-header">
            <div class="card-header-info">
                ...
                <div class="title" style="width: 20%;">Daftar Teguran</div>
            </div>
        </div>
        <div class="card-body">
            <table class="table" id="history-table">
                <thead>
                <th>No</th><th>Object Pajak</th><th>NPWP</th><th>Pokok</th><th>Denda</th><th>Tanggal Surat</th><th>Berakhir Sampai</th><th>Status Akhir</th>
                </thead>
            </table>
        </div>
